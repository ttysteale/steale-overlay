...
DEPEND=">=perl-gcpan/MooseX-MethodAttributes-0.30
	dev-perl/Plack
	dev-perl/Safe-Isa
	>=dev-perl/HTTP-Message-6.30.0
	>=perl-gcpan/Plack-Middleware-RemoveRedundantBody-0.05
	>=perl-gcpan/Plack-Middleware-MethodOverride-0.15
	dev-perl/Moose
	perl-gcpan/CGI-Struct
	...
	>=perl-gcpan/URI-ws-0.03
	dev-perl/Test-Fatal
	>=perl-gcpan/MooseX-Emulate-Class-Accessor-Fast-0.00903
	dev-perl/List-MoreUtils
	>=dev-perl/Class-Load-0.230.0
	>=dev-perl/URI-1.600.0
	dev-perl/CGI-Simple
	perl-gcpan/Plack-Test-ExternalServer
	>=perl-gcpan/Plack-Middleware-FixMissingBodyInRedirect-0.12
	dev-perl/Task-Weaken
	>=perl-gcpan/Text-SimpleTable-2.03
	dev-perl/Stream-Buffered
	dev-perl/HTML-Parser
	>=perl-gcpan/Plack-Middleware-ReverseProxy-0.15
	...
	>=perl-gcpan/Class-C3-Adopt-NEXT-0.14
